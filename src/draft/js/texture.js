...
//         canvastexture = p.createCanvas(p.windowWidth, pageHeight);
//         canvastexture.position(0, 0);
//         ` // canvasgrid.style('position', 'fixed');`
//         // canvasgrid.style('top', '0');
//         // canvasgrid.style('left', '0');
//         canvastexture.style('z-index', '-2');
//         canvastexture.style('pointer-events', 'none');
...
//         let x1 = Math.random() * p.windowWidth;
//         let y1 = Math.random() * pageHeight;
//         let theta = Math.random() * 2 * Math.PI;
//         let segmentLength = Math.random() * 5 + 2;
//         let x2 = Math.cos(theta) * segmentLength + x1;
//         let y2 = Math.sin(theta) * segmentLength + y1;
